...
namespace HitaRasDhara.Controllers
{
    public class QueryController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Index(QueryViewModel input)
        {
            try
            {
                var viewModel2 = new QueryViewModel();
        ...
        public JsonResult GetAllCountries()
        {
            ...
            return Json(obj.Select(t => t.Key), JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult getCountryCode()
        {
            ...
            return Json(dictionary.Select(t => t.Value), JsonRequestBehavior.AllowGet);
        }
    }
