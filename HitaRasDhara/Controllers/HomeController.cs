...
namespace HitaRasDhara.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            viewModel = new UpcomingKathaViewModel { KathaFeed = _dbContext.UpcomingKathaFeed.Select(m => m).Where(x => x.UnpublishDate > currTime).OrderBy(a => a.UnpublishDate).ToList().GetRange(0, 3) };
